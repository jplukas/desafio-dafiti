...
class NewPost(View):
    def get(self, request):
        form = PostForm()
        return render(request, 'create_update_post.html', {'form' : form, 'action' : 'new', 'header' : 'Novo Post'})
...
class EditPost(View):
    def get(self, request, id):
        ...
        return render(request, 'create_update_post.html', {'form' : form, 'action' : 'edit', 'header' : 'Novo Post'})
